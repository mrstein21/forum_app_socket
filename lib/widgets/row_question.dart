              ...
              children: [
                    ...
                    children: [
                      ...
                      Expanded(child: Container(
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(question.user.name,style: TextStyle(fontWeight: FontWeight.bold,fontFamily: "Roboto"),),
                            SizedBox(height: 4,),
                ...
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 4,),
                    Text(question.comment==0?"No Answer":question.comment.toString()+ " Answer",style: TextStyle(fontFamily: 'Roboto',fontWeight: FontWeight.bold)),
                  ],
                )
              ],
            ),
